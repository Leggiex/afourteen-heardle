!(function () {
  ...
  var artist = "Afourteen"; // the "theme" of your Heardle, doesn't need to be a single artist

  var startDate = "03/13/2025"; // must be mm/dd/yyyy format

  var songList = [
    // Put song items below this line. As many lines as you want.
    { artist: "Afourteen", name: "1 Million Darts", youtubeId: "PdrjlvxHPQs" },
    { artist: "Afourteen", name: "zak bagans", youtubeId: "dmXd3ccunQQ" },
    { artist: "Afourteen", name: "ANKLES", youtubeId: "fuqShJNunX8" },
    { artist: "Afourteen", name: "luol deng", youtubeId: "vt5SlXjoAF4" },
    { artist: "Afourteen", name: "USA", youtubeId: "ubv3MECabCQ" },
    { artist: "Afourteen", name: "Generations", youtubeId: "lEzYyThHfwE" },
    { artist: "Afourteen", name: "Hypothermia", youtubeId: "EnP2aApvq6I" },
    { artist: "Afourteen", name: "Learn 2 Live", youtubeId: "O6JrPicVOgA" },
    { artist: "Afourteen", name: "Obsolete", youtubeId: "pGvf_g6i5nE" },
    { artist: "fl.vco", name: "fetus (ft. afourteen)", youtubeId: "x3BHfhqc0KU" },
    { artist: "Afourteen", name: "Asmr", youtubeId: "1JX3EzDy7hA" },
    { artist: "Afourteen", name: "IM SO MAD ! IM SORRY DILLINGER !", youtubeId: "xMMBtLff4rE" },
    { artist: "Afourteen", name: "NOBODIES BEHIND YOU", youtubeId: "kzLAquOjcLM" },
    { artist: "Afourteen", name: "Desert Eagle", youtubeId: "bPZlgv3CRiA" },
    { artist: "Afourteen", name: "LILY PAD (feat. SKOTSKR)", youtubeId: "voe_w0_vah0" },
    { artist: "Afourteen", name: "Cigarette Cake", youtubeId: "ZwBWG-9WE1c" },
    { artist: "Afourteen", name: "BILL CIPHER ON METH", youtubeId: "mmKd8UiJzjw" },
    { artist: "Afourteen", name: "Groundhog", youtubeId: "5WcWF0tvSUc" },
    { artist: "Afourteen", name: "WET SOCKS", youtubeId: "DqhDDUWyjyY" },
    { artist: "Afourteen", name: "I DONT DANCE REMIX", youtubeId: "X9aNcZQY4m0" },
    { artist: "Afourteen", name: "Amerikkka", youtubeId: "Spuf0SOBQNk" },
    { artist: "Afourteen", name: "wimme", youtubeId: "xAwe_SSuVWE" },
    { artist: "Afourteen", name: "THE SQUIRRELS ARE ON FIRE", youtubeId: "WK4o-aEl2Q4" },
    { artist: "Afourteen", name: "Dumpster", youtubeId: "P2PTvE6t8zM" },
    { artist: "Afourteen", name: "hellhound", youtubeId: "LNOV0kJ6j50" },
    { artist: "Afourteen", name: "MISS THE RAGE", youtubeId: "fFrLIHFZ-2g" },
    { artist: "Afourteen", name: "KETAMINE KEITH", youtubeId: "9oreX5Gb7Sw" },
    { artist: "Afourteen", name: "SHUC (feat. LIL DARKIE)", youtubeId: "oysqb2uIGUo" },
    { artist: "Afourteen", name: "9AM", youtubeId: "la1NAzJqv10" },
    { artist: "Afourteen", name: "VOLKSWAGEN GOLF", youtubeId: "7FHhuyPewrk" },
    { artist: "Afourteen", name: "Plz Don't Cry", youtubeId: "TG_i8KsYBw8" },
    { artist: "Afourteen", name: "I'm Gonna DIE in This CAR", youtubeId: "AE-C533wOCk" },
    { artist: "Afourteen", name: "Ruffian (feat. Teenage Disaster)", youtubeId: "OwUhQVQl-z0" },
    { artist: "Afourteen", name: "Oxter", youtubeId: "czP58BjPDwQ" },
    { artist: "Afourteen", name: "20 MORE MINUTES TILL FALL", youtubeId: "JrVtuEh9kG0" },
    { artist: "Afourteen", name: "Drowning", youtubeId: "PqwNIifHaGY" },
    { artist: "Afourteen", name: "almost drowned washing my hands", youtubeId: "lypVgZfpOik" },
    { artist: "Afourteen", name: "!", youtubeId: "Jqvr9xfgmQA" },
    { artist: "Afourteen", name: "hard2live", youtubeId: "n9x3C_DD5MY" },
    { artist: "Afourteen", name: "Malistaire", youtubeId: "DdTdKBlU9tc" },
    { artist: "Afourteen", name: "AUDIBLE HEROIN", youtubeId: "fpZbGM9h2S4" },
    { artist: "Afourteen", name: "LAME (feat. TEENAGE DISASTER, LIEU)", youtubeId: "EptL6bm_pxY" },
    { artist: "Afourteen", name: "SAFETY OFFICER RICHARDS (feat. JELEEL!)", youtubeId: "o3b5NxMw5Ww" },
    { artist: "Afourteen", name: "HI (FT. FL.VCO)", youtubeId: "oW6MhVIbiJ0" },
    { artist: "Afourteen", name: "Chemical Head", youtubeId: "yWGKs2R1ejg" },
    { artist: "Afourteen", name: "Vicodin Faggot (feat. Madjax)", youtubeId: "nivFP7Pc8wg" },
    { artist: "Afourteen", name: "Care I Give", youtubeId: "bivK9jB9pKU" },
    { artist: "Afourteen", name: "MIKE AND IKE", youtubeId: "EnB5WzKBVyE" },
    { artist: "Afourteen", name: "Chicken Dance", youtubeId: "dc6M-vr0LWM" },
    { artist: "Afourteen", name: "gov issue", youtubeId: "8fz_mPLOm60" },
    { artist: "Afourteen", name: "5up", youtubeId: "qbVCMmkCkpw" },
    { artist: "Afourteen", name: "RICKY BOBBY (FT. FL.VCO)", youtubeId: "UwGkDTj-Yr4" },
    { artist: "Afourteen", name: "OMNIVORE", youtubeId: "2SG1SiO4ko4" },
    { artist: "Afourteen", name: "Bars FAT (feat. LIL Darkie)", youtubeId: "5PGdqsoL5jA" },
    { artist: "Afourteen", name: "Duffle BAG BOY", youtubeId: "Xc0lHzoUJh0" },
    { artist: "Afourteen", name: "assa w/ madjax & triplesixdelete", youtubeId: "6Rta9BRGrk4" },
    { artist: "Afourteen", name: "22", youtubeId: "OzfnttF_wps" },
    { artist: "Afourteen", name: "Happy Halloween", youtubeId: "ubgeAVTfm_8" },
    { artist: "Afourteen", name: "HAG (FT. FL.VCO)", youtubeId: "Utb1ODD2sL4" },
    { artist: "Afourteen", name: "BAD GUY (feat. LIL Darkie)", youtubeId: "kQyTQfm1MWg" },
    { artist: "Afourteen", name: "STRAIN", youtubeId: "kQFxx6ta484" },
    { artist: "Afourteen", name: "RICK OWENS TOTE BAG", youtubeId: "4RmmYKGryFY" },
    { artist: "Afourteen", name: "Dirtbag", youtubeId: "scMosi3CJgQ" },
    { artist: "Afourteen", name: "RED School BUS", youtubeId: "VoXWGkvSeyI" },
    { artist: "Afourteen", name: ":( (feat. Cherry ills)", youtubeId: "gCrbQB5Y6Hs" },
    { artist: "Afourteen", name: "als", youtubeId: "0kbZR4JFbmo" },
    { artist: "fl.vco", name: "weedle tart fridge (ft. afourteen)", youtubeId: "e2boP4Lh6I8" },
    { artist: "Afourteen", name: "RICK OWENS TOTE BAG 2", youtubeId: "TdZktFgzTrc" },
    { artist: "fl.vco", name: "fuqass (ft. afourteen)", youtubeId: "9Zy1cBdTtfk" },
    { artist: "Afourteen", name: "BEAUTY IN THE BREAKDOWN", youtubeId: "J0LZ2A1pxdA" },
    { artist: "Afourteen", name: "Chug Jug Titties", youtubeId: "nfxZRngKono" },
    { artist: "Afourteen", name: "Sippin' Antifreeze", youtubeId: "wlWcLhODU5M" },
    { artist: "Afourteen", name: "SPINES", youtubeId: "5CbsABQlHKo" },
    { artist: "Afourteen", name: "HATE THAT i EXIST", youtubeId: "AwLB0M6yvYM" },
    { artist: "Afourteen", name: "50ng", youtubeId: "hjs70uXSc8E" },
    { artist: "Afourteen", name: "Persona Non Grata", youtubeId: "czQU2nZzH1U" },
    { artist: "Afourteen", name: "uav", youtubeId: "VZFzYvU2ciI" },
    { artist: "Afourteen", name: "Schmuck", youtubeId: "uuH1WUKulAs" },
    { artist: "Afourteen", name: "Cuss Words", youtubeId: "JlPrTHiaX-w" },
    { artist: "Afourteen", name: "Thumbfuck", youtubeId: "lqMnISq4M2Q" },
    { artist: "Afourteen", name: "Clementine", youtubeId: "2W5lyLnBuHI" },
    { artist: "Afourteen", name: "Smile Child", youtubeId: "Nqz0IDNAwPs" },
    { artist: "Afourteen", name: ":)", youtubeId: "tXG5gAlOqIg" },
    { artist: "Afourteen", name: "You", youtubeId: "-eiGIPx2ud0" },
    { artist: "Afourteen", name: "Somniphobia", youtubeId: "2fr19e3n7no" },
    { artist: "Afourteen", name: "p.o.", youtubeId: "_9vFCS1UT9g" },
    { artist: "Afourteen", name: "HUMAN RACE", youtubeId: "Zwuoej8XF-0" },
    { artist: "Afourteen", name: "b4 i sleep", youtubeId: "R4djpC40cJw" },
    { artist: "Afourteen", name: "ongod", youtubeId: "Qvtv3CYwgLE" },
    { artist: "Afourteen", name: "MINIGUN MARVIN (feat. JOHNNASCUS)", youtubeId: "9A1mL8k8fTA" },
    { artist: "Afourteen", name: "Skeng", youtubeId: "NPrl3dHuXcM" },
    { artist: "Afourteen", name: "DRINK WATER OR DIE", youtubeId: "5EfXtp9TxWg" },
    { artist: "Afourteen", name: "Tonsil", youtubeId: "Nh5um30uEsU" },
    { artist: "Afourteen", name: "Beautiful Maiden", youtubeId: "ff8WMi-lE_U" },
    { artist: "Afourteen", name: "YOUR GONNA DIE IN THIS CAR", youtubeId: "ZnmmhB4glns" },
    { artist: "Afourteen", name: "I AM NOT IMPORTANT", youtubeId: "Ee3P9-wqX7s" },
    { artist: "Afourteen", name: "LYRE", youtubeId: "tWciHfh_o-A" },
    { artist: "Afourteen", name: "Pitiful (feat. Madjax) (Prod. Luisproducedit)", youtubeId: "K46DK-vEDkQ" },
    { artist: "Afourteen", name: "maison", youtubeId: "WDtIB9MsTQI" },
    { artist: "Afourteen", name: "Grunts", youtubeId: "YF1uUe7SJy0" },
    { artist: "Afourteen", name: "13TH", youtubeId: "7Zwi6W-0lzI" },
    { artist: "Afourteen", name: "lmfao", youtubeId: "FnHNJmeQ4zk" },
    { artist: "fl.vco", name: "smiling is for losers (ft. afourteen)", youtubeId: "B-M40fi65mo" },
    { artist: "Afourteen", name: "At The Bottom Again", youtubeId: "tRNKsCMZChE" },
    { artist: "Afourteen", name: "rip sn", youtubeId: "0z87XPXQd6o" },
    { artist: "Afourteen", name: "PT 1... THERE IS NEVER A Pt. 2", youtubeId: "X48qb7y4cgs" },
    { artist: "Afourteen", name: "Nypd", youtubeId: "9ppWDogSifs" },
    { artist: "Afourteen", name: "NEWPORT NERMAN", youtubeId: "IeOseO-T1yA" },
    { artist: "Afourteen", name: "MY DMS", youtubeId: "ChQBmRpYb6w" },
    { artist: "Afourteen", name: "PENIS MUSIC 2 TAKE 2", youtubeId: "fHv9dLsr3MU" },
    { artist: "Afourteen", name: "Dirty Mouth (Prod. Luisproducedit)", youtubeId: "vGS235IR0A8" },
    { artist: "Afourteen", name: "I GOT A TATTOO YESTERDAY LOL", youtubeId: "9M_AxpW099U" },
    { artist: "Afourteen", name: "METAMORPHIS STIMULATION", youtubeId: "2TuuND21eCU" },
    { artist: "Afourteen", name: "plz dont cry 2", youtubeId: "s840pml57Qc" },
    { artist: "Afourteen", name: "Stay Up", youtubeId: "AIQgwHSd9gI" },
    { artist: "Afourteen", name: "Melody Felony", youtubeId: "Gj4_dPiHLM0" },
    { artist: "Afourteen", name: "PENIS MUSIC 2: TAKE 1", youtubeId: "NBfdkc6uNnM" },
    { artist: "Afourteen", name: "FLOWER129 (FT. FL.VCO)", youtubeId: "tjXeoYlHet8" },
    { artist: "Afourteen", name: "Respawn", youtubeId: "nBQDbdEnF-4" },
    { artist: "Afourteen", name: "DR Galoopen (feat. Teenage Disaster)", youtubeId: "WlbxWPZNFDc" },
    { artist: "Afourteen", name: "THE BIRDS DONT WALK THEY ARE GOVERNMENT DRONES", youtubeId: "FoDD88QWK5o" },
    { artist: "Afourteen", name: "MARTHA", youtubeId: "wzg-l5ihKzE" },
    { artist: "Afourteen", name: "GUT Wrenched", youtubeId: "ZxQDrWHAxnk" },
    { artist: "Afourteen", name: "Breaknose!", youtubeId: "GBtfZBtb5Q8" },
    { artist: "Afourteen", name: "FIGHT THE RATS IN THE WALLS", youtubeId: "aeP6M7xEdAY" },
    { artist: "Afourteen", name: "HALLOWEEN SUICIDE (feat. TEENAGE DISASTER)", youtubeId: "3HW4k4lDpfI" },
    { artist: "Afourteen", name: "BLACK FLAMINGO", youtubeId: "V4DU9H5bO5M" },
    { artist: "Afourteen", name: "PULE (feat. MADJAX)", youtubeId: "IXkeDRELz0g" },
    { artist: "Afourteen", name: "GOID", youtubeId: "bB4aktUJopo" },
    { artist: "Afourteen", name: "DIE (feat. Blckk/Hxstage)", youtubeId: "k7bz-vXX_Fg" },
    { artist: "Afourteen", name: "gave my life", youtubeId: "adOo4zkaSdU" },
    { artist: "Afourteen", name: "HECATE", youtubeId: "_4-iO7Dvgg0" },
    { artist: "Afourteen", name: "Alfredo", youtubeId: "EbcQg1_3gV4" },
    { artist: "Afourteen", name: "Snot Rocket", youtubeId: "d4vGikxCsf0" },
    { artist: "Afourteen", name: "Headache", youtubeId: "RuB1pWFnok8" },
    { artist: "Afourteen", name: "BOBBYCHEW", youtubeId: "UenaDYRacSM" },
    { artist: "Afourteen", name: "Waste of Space", youtubeId: "pFvvgVZkuN4" },
    { artist: "Afourteen", name: "Bikini Bottom Flow", youtubeId: "UaNcM-qZA8U" },
    { artist: "Afourteen", name: "Jumpin' in the Junk", youtubeId: "FIfmrc7avd0" },
    { artist: "Afourteen", name: "Breathe Again", youtubeId: "p_VSG1UJTQg" },
    { artist: "Afourteen", name: "Corinne", youtubeId: "G_RELp3QmJ4" },
    { artist: "Afourteen", name: "Grekom (feat. Teenage Disaster)", youtubeId: "2yjpS5UXETo" },
    { artist: "Afourteen", name: "Itsy Bitsy Spider", youtubeId: "mfLW2EsCfGk" },
    { artist: "Afourteen", name: "Smonk (feat. FL.Vco)", youtubeId: "MkSjwyrdgO4" },
    { artist: "Afourteen", name: "PUT ME IN THE RING", youtubeId: "g0OH-MCf53E" },
    { artist: "Afourteen", name: "SUBURBAN SOCIOPATH (ft. Teenage Disaster)", youtubeId: "xHuDDeMEKsM" },
    { artist: "Afourteen", name: "MURDER SUSPECT", youtubeId: "a6Vwt6r2T0w" },
    { artist: "Afourteen", name: "green day", youtubeId: "GL10MyhxGU4" },
    { artist: "Afourteen", name: "BUTTFUCK", youtubeId: "6nMFxt6ts9w" },
    { artist: "Afourteen", name: "madasf", youtubeId: "rqee4RbYmjE" },
    { artist: "Afourteen", name: "Dexy", youtubeId: "pZXsKnacIUM" },
    { artist: "Afourteen", name: "Boobie Song", youtubeId: "KzOTnmVcV7Y" },
    { artist: "Afourteen", name: "Asinine", youtubeId: "HUkL76NEwpM" },
    { artist: "Afourteen", name: "h3ll y3ah", youtubeId: "jM4mx4LwTkw" },
    { artist: "Afourteen", name: "BROKEN BONES IN MY CHEST", youtubeId: "bAbtxLU0yZ4" },
    { artist: "Afourteen", name: "l8r", youtubeId: "E1lcix8muKM" },
    { artist: "Afourteen", name: "Wednesday", youtubeId: "kSZs_Zm4CyA" },
    { artist: "Afourteen", name: "MONEY TSUNAMI", youtubeId: "8xNH7l2gk6o" },
    { artist: "Afourteen", name: "I WANNA DIE AS MUCH AS THE NEXT GUY", youtubeId: "L7a53r5q5GA" },
    { artist: "Afourteen", name: "Woke Up on the Sky", youtubeId: "gNNT4LV1fjU" },
    // Put song items above this line.
  ];

  var icon_url =
    "https://cdn.glitch.global/0189167b-9301-4183-ba2e-bdecb30bef5c/head.png?v=1741394698767"; // see README for instructions

  var image_url = ""; // optional. defaults to the same as icon_url above.

  // --------------------- END CUSTOMIZATION ----------------------------------------------------

  // If you are just creating a new Heardle variant,
  ...
  head_title.innerHTML = `${artist} Heardle`;

  var meta_name = document.createElement("meta");
  meta_name.setAttribute("itemprop", "name");
  meta_name.setAttribute("content", `${artist} Heardle`);
  document.getElementsByTagName("head")[0].appendChild(meta_name);

  var meta_description = document.createElement("meta");
  meta_description.setAttribute("itemprop", "description");
  meta_description.setAttribute(
    "content",
    `Guess the ${artist} song in as few tries as possible.`
  );
  ...
  meta_og_url.setAttribute("content", document.location);
  document.getElementsByTagName("head")[0].appendChild(meta_og_url);

  var meta_og_title = document.createElement("meta");
  meta_og_title.setAttribute("property", "og:title");
  meta_og_title.setAttribute("content", `${artist} Heardle`);
  document.getElementsByTagName("head")[0].appendChild(meta_og_title);

  var meta_x_title = document.createElement("meta");
  meta_x_title.setAttribute("name", "twitter:title");
  meta_x_title.setAttribute("content", `${artist} Heardle`);
  document.getElementsByTagName("head")[0].appendChild(meta_x_title);

  var meta_og_description = document.createElement("meta");
  meta_og_description.setAttribute("property", "og:description");
  meta_og_description.setAttribute(
    "content",
    `Guess the ${artist} song in as few tries as possible.`
  );
  document.getElementsByTagName("head")[0].appendChild(meta_og_description);

  var meta_x_description = document.createElement("meta");
  meta_x_description.setAttribute("name", "twitter:description");
  meta_x_description.setAttribute(
    "content",
    `Guess the ${artist} song in as few tries as possible.`
  );
  document.getElementsByTagName("head")[0].appendChild(meta_x_description);

  var meta_image = document.createElement("meta");
  meta_image.setAttribute("itemprop", "image");
  meta_image.setAttribute("content", image_url);
  document.getElementsByTagName("head")[0].appendChild(meta_image);

  var meta_og_image = document.createElement("meta");
  meta_og_image.setAttribute("itemprop", "og:image");
  meta_og_image.setAttribute("content", image_url);
  document.getElementsByTagName("head")[0].appendChild(meta_og_image);

  var meta_x_image = document.createElement("meta");
  meta_x_image.setAttribute("name", "twitter:image");
  meta_x_image.setAttribute("content", image_url);
  document.getElementsByTagName("head")[0].appendChild(meta_x_image);

  var icon_image = document.createElement("link");
  icon_image.setAttribute("rel", "icon");
  icon_image.setAttribute("href", icon_url);
  document.getElementsByTagName("head")[0].appendChild(icon_image);

  // the actual application stuff
  var e = {
      262: function (e) {
        "use strict";
              ...
              navigator.clipboard.writeText(
                (function (e) {
                  var t = new Date(startDate),
                    ...
                    u = "\u2b1c", // white square ⬜
                    i = "\u2b1b\ufe0f", // black square ⬛
                    l = artist + " Heardle - #".concat(r, " \ud83d\udd08"), // artist + heardle + game # + speaker 🔊
                    c = "";
                  // NOTE: This is the code that generates the score output at the end of the game
                  return (
                    e.forEach(function (e) {
                      !0 === e.isCorrect
                        ? (c += a)
